infos = {
        "Euclid":{"marker":'o',
                  ...
                  "surveys":{"Wide Survey":{
                                 "instruments":{"VIS": {"pix_scale":0.1,
                                                ...
                                                "major_band":"VIS",
                                                "bands":
                                                        {"VIS": {"mag":25.2, "min_max":[550, 900], 'fwhm':0.17}}
                                                        },
                                                "NIR": {"pix_scale":0.3,
                                                        "noise_level":0.009,
                                                "ls":'-',
                                                ...
                                                "major_band":"J",
                                                "bands":{"Y": {"mag":24, "min_max":[920, 1046], 'fwhm':0.2},
                                                                "J": {"mag":24, "min_max":[1146, 1372], 'fwhm':0.2},
                                                                "H": {"mag":24, "min_max":[1372, 2000], 'fwhm':0.2}
                                                                }
                                                        }
                                                },
                                             },
        ...
        "LSST": {"marker":"D",
                 ...
                 "color": "green",
                 "major_band":"z",
                 "instruments":{"Rubin":{'pix_scale':0.08,
                                        "noise_level":0.001,
                                         'ls':'-',
                                         'depth':24.5,
                                         'fwhm':0.8,
        ...
        "JWST": {"mirror": 6.5,
                ...
                "marker":'X',
                "fov": [2.2, 2.2],
                "instruments": {"NIRCAM":{'pix_scale':0.031,
                                         "noise_level":0.0001,
                                          'ls':'-',
                                          'depth':28,
                                          'fwhm':0.06,
                                          'major_band':'f606W',
                                          'bands':{'F070W':{"mag":28, "min_max":[621, 781], 'fwhm':0.08},  #mag is 10sigma point sources limit
                                                'F090W':{"mag":23.5, "min_max":[795, 1005], 'fwhm':0.08},
                                                'F115W':{"mag":23.5, "min_max":[1013, 1282], 'fwhm':0.08},
                                                'F140M':{"mag":23.5, "min_max":[1331, 1479], 'fwhm':0.08},
                                                'F150W':{"mag":23.5, "min_max":[1331, 1668], 'fwhm':0.08},
                                                'F162M':{"mag":23.5, "min_max":[1542, 1713], 'fwhm':0.08},
                                                'F164NW':{"mag":23.5, "min_max":[1635, 1653], 'fwhm':0.08},
                                                'F150W2':{"mag":23.5, "min_max":[1008, 2334], 'fwhm':0.08},
                                                'F182M':{"mag":23.5, "min_max":[1722, 1968], 'fwhm':0.08},
                                                'F187N':{"mag":23.5, "min_max":[1863, 1884], 'fwhm':0.08},
                                                'F200W':{"mag":23.5, "min_max":[1755, 2226], 'fwhm':0.08},
                                                'F210M':{"mag":23.5, "min_max":[1992, 2201], 'fwhm':0.08},
